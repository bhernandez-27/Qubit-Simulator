...
Or so I thought. I realized shortly after writing my first few classes that using Webassembly would be too tedious and using hhtp server communication would over-complicate this app for no reason. 
